...
*   **[x] T1.1: 建立 Docker Compose 資料庫服務**
...
*   **[x] T1.3: 初始化後端 Node.js Express 專案**
...
*   **[x] T5.2: 實作銷售單明細數量與單價校驗**
    *   **內容**：明細中 quantity 必須大於 0。
    *   **驗證標準**：數量為 0 或負數，整個交易回滾。
*   **[x] T5.3: 實作悲觀鎖出貨扣庫交易 (SELECT FOR UPDATE)**
...
**Version**: 1.3.0 | **Ratified**: 2026-05-23 | **Last Amended**: 2026-05-23
